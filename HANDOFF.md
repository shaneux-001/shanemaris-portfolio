...
- [~] **Phase 5 — Tailwind v4 wiring. IN PROGRESS (2026-09-05).** Converted so far: layout.tsx header, Home, About, Work index, and the shared components (PressCta, PressThemeToggle, SiteFooter, Expertise). Remaining: Contact, Resume, Proof Before Progress (landing + 4 chapters).
