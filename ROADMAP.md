...
- [ ] Performance / Lighthouse pass — site still uses plain `<img>` tags everywhere (confirmed zero `next/image` usages as of 2026-09-13), never migrated. Target Lighthouse 90+, check Core Web Vitals. This is now actually measurable/actionable — real photography is in place across all 3 live case studies as of this week, where previously most image weight was still placeholder.
