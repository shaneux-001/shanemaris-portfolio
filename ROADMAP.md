...
- [ ] **Resume date: 2011 vs. 2012 — still needs Shane's direct answer**, now more pressing since the resume just got locked in for real. See "Needs manual verification" above for the full context.
- [ ] Whether the RZF/agency-partnership story (proving the UX skillset could be brought in-house during Vision's launch) should become a new bullet under Web Designer or UX Designer — flagged during the resume pass, not yet drafted.
